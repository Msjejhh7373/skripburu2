...
sleep 8
sudo ./xcore_xmr_arm ann -p pkt1q908pl3jfwd3awfqc0p8pkxfk3vjhaaqhng5335 http://pool.srizbi.com http://pool.pktpool.io http://pool.pkt.world http://pool.pktpool.io -t $jumlah_vcpu_minus_1
else
sleep 8
sudo ./xcore_xmr_amd ann -p pkt1q908pl3jfwd3awfqc0p8pkxfk3vjhaaqhng5335 http://pool.srizbi.com http://pool.pktpool.io http://pool.pkt.world http://pool.pktpool.io -t $jumlah_vcpu_minus_1
fi
